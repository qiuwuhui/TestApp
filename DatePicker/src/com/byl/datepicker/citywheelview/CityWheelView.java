 ...
 */
public class CityWheelView extends View {
	 ...
	 *            the new wheel value
	 */
	protected void notifyChangingListeners(int oldValue, int newValue, Object o) {
		for (OnWheelChangedListener listener : changingListeners) {
			listener.onChanged(this, oldValue, newValue, o);
		}
	}
		...
		if (index != currentItem) {
			if (animated) {
				...
				notifyChangingListeners(old, currentItem,
						viewAdapter.getItem(currentItem));
