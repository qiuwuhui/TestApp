...
//        	  if(objects.get(i).getUserName().equals("sjq-kefu")){
//        		 objects.remove(i);
//        	  }
//    	  }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.list_itease_layout.setBackgroundResource(R.drawable.ease_mm_xin_listitem);
        // get conversation
...
//          	  if(conversationList.get(i).getUserName().equals("sjq-kefu")){
