 ...
 *
 */
public class EaseChatFragment1 extends EaseBaseFragment implements EMMessageListener {
    ...
    protected String toChatUserGuid;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.ease_fragment_chat2, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        toChatUserGuid = fragmentArgs.getString(EaseConstant.SHE_JI_SHI_GUID);
    ...
    protected void onConversationInit(){
        ...
        conversation.setExtField(toChatUserGuid);
