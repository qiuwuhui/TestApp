package com.guojisheng.koyview.indicator;
...
import com.guojisheng.koyview.indicator.base.PageIndicator;
...
public class RoundCornerIndicaor extends View implements PageIndicator {
    ...
    private ArrayList<GradientDrawable> unselectDrawables = new ArrayList<GradientDrawable>();
    private ArrayList<Rect> unselectRects = new ArrayList<Rect>();
    ...
    public void setViewPager(ViewPager vp) {
        if (isValid(vp)) {
            ...
            vp.setOnPageChangeListener(null);
