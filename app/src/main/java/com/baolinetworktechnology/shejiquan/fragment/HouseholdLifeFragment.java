...
import com.baolinetworktechnology.shejiquan.view.ListViewNewsHous;
...
public class HouseholdLifeFragment extends BaseFragment implements RefreshListView.ILoadData {
    private ListViewNewsHous mListViewNews;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (layout == null){
            layout=inflater.inflate(R.layout.zi_xunhouse_fragment, container, false);
            ding_bu = (ImageView) layout.findViewById(R.id.ding_bu);
            ding_bu.setOnClickListener(this);
            mListViewNews = (ListViewNewsHous) layout.findViewById(R.id.houslistView);
            mListViewNews.setonStateListener(onStateListener);
            time = new CountDownTimer(800, 800) {
                ...
                public void onFinish() {
                    mListViewNews.setCaceKey("HouseholdLifeFragment");
                    mListViewNews.setDev(1);
                    mListViewNews.setClassID(155,0);
                }
            };
            time.start();
        }
