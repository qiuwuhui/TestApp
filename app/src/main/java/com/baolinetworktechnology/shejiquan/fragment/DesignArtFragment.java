...
import com.baolinetworktechnology.shejiquan.view.ListViewNewsDesig;
import com.baolinetworktechnology.shejiquan.view.RefreshListView;
/**
 * Created by Administrator on 2017/3/20.
 */

public class DesignArtFragment extends BaseFragment implements RefreshListView.ILoadData {
    private ListViewNewsDesig mListViewNews;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (layout == null){
            layout=inflater.inflate(R.layout.zu_xundesi_fragment, container, false);
            ding_bu = (ImageView) layout.findViewById(R.id.ding_bu);
            ding_bu.setOnClickListener(this);
            mListViewNews = (ListViewNewsDesig) layout.findViewById(R.id.desilistView);
            mListViewNews.setonStateListener(onStateListener);
            time = new CountDownTimer(800, 800) {
                ...
                public void onFinish() {
                    mListViewNews.setCaceKey("DesignArtFragment");
                    mListViewNews.setDev(1);
                    mListViewNews.setClassID(148,0);
                }
            };
            time.start();
        }
