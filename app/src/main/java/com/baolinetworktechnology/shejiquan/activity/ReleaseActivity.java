...
import com.baolinetworktechnology.shejiquan.view.NoScrollGridView;
...
public class ReleaseActivity extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parentView = getLayoutInflater().inflate(
                R.layout.activity_release, null);
        setContentView(parentView);
        //魅族
        CommonUtils.setMeizuStatusBarDarkIcon(ReleaseActivity.this, true);
        //小米
        CommonUtils.setMiuiStatusBarDarkMode(ReleaseActivity.this, true);
    ...
    private void inview() {
        ...
        etitText.addTextChangedListener(watcher);
        etitConten.addTextChangedListener(watcher);
        pop = new PopupWindow(ReleaseActivity.this);
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                if (position == Pictures.addrs.size()) {
                    ...
                    inputMethodManager.hideSoftInputFromWindow(
                            ReleaseActivity.this.getCurrentFocus()
                                    .getWindowToken(),
    ...
    public void onClick(View view) {
            switch (view.getId()){
                ...
                case R.id.tv_title2:
                    ...
                    tv_title2.setEnabled(false);
                    if(etitText.getText().toString().length()<4){
                        toastShow("标题最少4个字");
    ...
    private void addPost(final List<PathBean> logoUrl) {
        ...
        try {
            ...
            param.put("title", etitText.getText().toString());
            param.put("enumMarkName", "1");
            ...
            public void onSuccess(ResponseInfo<String> n) {
                ...
                if (bean != null) {
                    if (bean.result.operatResult) {
                        toastShow("发布成功");
                        Pictures.clearCache();
                        Intent brodacast = new Intent();
                        brodacast.setAction("RefreshSQ");
                        sendBroadcast(brodacast);
                        Intent intent = new Intent(getActivity(), PostDetailsActivity.class);
                        intent.putExtra(AppTag.TAG_GUID,bean.result.extra);
    ...
    private void go2Login() {
        Intent intent = new Intent(ReleaseActivity.this, LoginActivity.class);
        startActivity(intent);
    }
...
//                    setListViewHeightBasedOnChildren(noScrollgridview);
    ...
    private TextWatcher watcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence arg0, int arg1, int arg2,
                                  int arg3) {
            biaoti = etitText.getText().toString().trim();
            comment = etitConten.getText().toString().trim();
            if(biaoti.length()>3 && !comment.equals("")){
                tv_title2.setEnabled(true);
    ...
    protected void onPause() {
        ...
        imm.hideSoftInputFromWindow(etitText.getWindowToken(), 0); //强制隐藏键盘
    }
    @Override
    ...
    public void permissionSuccess(int requestCode) {
        ...
        switch (requestCode) {
            case 0x0002:
                    Intent intent1 = new Intent(ReleaseActivity.this,
                            PhotoAlbum.class);
            ...
            case 0x0003:
                    ...
                    if (status.equals(Environment.MEDIA_MOUNTED)) {
                        try {
                            ...
                            Toast.makeText(ReleaseActivity.this, "没有找到储存目录",
                                    Toast.LENGTH_LONG).show();
                        }
                    } else {
                        Toast.makeText(ReleaseActivity.this, "没有储存卡",
                                Toast.LENGTH_LONG).show();
                    }
                    pop.dismiss();
                    ll_popup.clearAnimation();
