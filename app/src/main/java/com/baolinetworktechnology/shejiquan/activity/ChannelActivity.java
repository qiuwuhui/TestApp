...
import com.baolinetworktechnology.shejiquan.adapter.OtherAdapter;
import com.baolinetworktechnology.shejiquan.constant.AppStatusConstant;
import com.baolinetworktechnology.shejiquan.manage.ChanneManage;
import com.guojisheng.koyview.DragGrid;
import com.guojisheng.koyview.OtherGridView;
import com.guojisheng.koyview.adapter.DragAdapter;
...
public class ChannelActivity extends BaseActivity implements
	...
	private void initData() {
		mUserChannelList = ChanneManage.getInstance(this).mUserChannelList;
		mOtherChannelList = ChanneManage.getInstance(this).mOtherChannelList;
						...
						public void run() {
							try {
								...
								mOtherGridView.getChildAt(
										mOtherGridView.getLastVisiblePosition())
	...
	private void saveChannel() {
		...
		ChanneManage.getInstance(this).saveData(this);
	}
