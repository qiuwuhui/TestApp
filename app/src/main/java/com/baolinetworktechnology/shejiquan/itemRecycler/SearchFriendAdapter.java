...
public class SearchFriendAdapter extends RecyclerView.Adapter{
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if(news.getWatch()){
            holder1.tx_guan.setImageResource(R.drawable.tx_delete_guan);
        }else{
            holder1.tx_guan.setImageResource(R.drawable.tx_add_guan);
        }
        ...
        holder1.tx_guan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int posiItem = (int) v.getTag();
                if(!mList.get(position).getWatch()){
                    SavePosts(posiItem);
                }
            }
        });
                        ...
                        public void onSuccess(ResponseInfo<String> n) {
                            ...
                            if (bean != null) {
                                if (bean.result.operatResult) {
                                    mList.get(posiItem).setWatch(true);
