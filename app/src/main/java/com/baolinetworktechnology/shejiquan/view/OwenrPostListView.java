 ...
 * 
 */
public class OwenrPostListView extends PullToRefreshListView {
	private HttpUtils mHttpUtils;
	// private RequestCallBack<String> callBack;
	private SwOwnerPotAdapter mCollAdapter;
	...
	String caceKey = "";
	Context mContext;
	public OwenrPostListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void initView() {
		...
		mCollAdapter = new SwOwnerPotAdapter(getActivity());
	...
	private void loadData(final boolean falg) {
		...
		String url = AppUrl.GETPAGELIST+"pageSize=10"+"&currentPage="+mPageIndex+"&userGUID="+mUserGuid+"&IsRefresh=true";
