...
public class ListViewNewsCons extends MyListView implements OnClickListener {
	...
	public ListViewNewsCons(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		initView();
	}

	public ListViewNewsCons(Context context) {
		super(context);
		...
		setOnScrollListener(new OnScrollListener() {
			...
			public void onScroll(AbsListView view, int firstVisibleItem,
				...
				if(firstVisibleItem>=15){
					...
					intent.setAction("Constellationshow");
