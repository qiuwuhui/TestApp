...
public class CircleImg extends ImageView {
	...
	private static final int DEFAULT_BORDER_COLOR = 0x50F0F0F0;
	...
	public CircleImg(Context context, AttributeSet attrs, int defStyle) {
		...
		mBorderWidth = a.getDimensionPixelSize(
				R.styleable.Circleview_border_widt, DEFAULT_BORDER_WIDTH);
		mBorderColor = a.getColor(R.styleable.Circleview_border_colo,
