 ...
 * 
 */
public class ListDesigner extends MyListView implements OnClickListener {
	...
	public ListDesigner(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext=context;
		initView();
	}

	public ListDesigner(Context context) {
		super(context);
		...
		setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(getActivity(),
						WeiShopActivity.class);// WeiActivity//WeiShopActivity WeiShopWebActivity2.1版
		...
		setOnScrollListener(new OnScrollListener() {
			...
			public void onScroll(AbsListView view, int firstVisibleItem,
				...
				if(firstVisibleItem>=6){
					...
					intent.setAction("MainDesignershow");
		...
		if (KeyWord != null) {
			try {
				url = AppUrl.DESIGNER + "currentPage=" + mPageIndex
						+ "&PageSize=10&cityID=" + mCityID + "&desStyle=" + tags
						+ "&Cost=" + URLEncoder.encode(cost, "utf-8") + "&Sex="
						+ sex + "&DesArea=" + workYear + "&KeyWord="
						+ URLEncoder.encode(KeyWord, "utf-8") + "&WorkCompany="
						+ URLEncoder.encode(WorkCompany, "utf-8")
						+ "&hasCaseInfo=true"+"&caseCount=3";
			...
			try {
				url = AppUrl.DESIGNER + "currentPage=" + mPageIndex
						...
						+ "&DesArea=" + workYear + "&order=" + OrderBy+
						"&hasCaseInfo=true"+"&caseCount=3";
			} catch (UnsupportedEncodingException e) {
			}
		}
	...
	String tags = "0", cost = "", workYear = "0", sex = "", WorkCompany = "";
