 ...
 * 时间：2016/5/10
 */
public abstract class PerNineGridLayout extends ViewGroup {
    ...
    private ArrayList<String> damUrlList = new ArrayList<>();
    public PerNineGridLayout(Context context) {
        super(context);
        init(context);
    }

    public PerNineGridLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setdaUrlList(List<String> urlList) {
        if (getListSize(urlList) == 0) {
            return;
        }
        damUrlList.clear();
        damUrlList.addAll(urlList);
    }
    ...
    private void refresh() {
        ...
        if (size == 1) {
            ...
            PerRatioImageView imageView = createImageView(0, url);
    ...
    private PerRatioImageView createImageView(final int i, final String url) {
        PerRatioImageView imageView = new PerRatioImageView(mContext);
        imageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
//        imageView.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                String daurl = damUrlList.get(i);
//                onClickImage(i, daurl, damUrlList);
...
//        });
     ...
     */
    private void layoutImageView(PerRatioImageView imageView, int i, String url, boolean showNumFlag) {
        ...
        if (showNumFlag) {//添加超过最大显示数量的文本
            ...
            if (overCount > 0) {
                ...
                textView.setText("共" + String.valueOf(overCount)+"张");
    ...
    protected void setOneImageLayoutParams(PerRatioImageView imageView, int width, int height) {
...
//        params.width = width;
     ...
     */
    protected abstract boolean displayOneImage(PerRatioImageView imageView, String url, int parentWidth);

    protected abstract void displayImage(PerRatioImageView imageView, String url);
