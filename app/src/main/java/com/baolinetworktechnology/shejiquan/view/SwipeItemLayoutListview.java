...
public class SwipeItemLayoutListview extends RelativeLayout {

    private static final String TAG = SwipeItemLayoutListview.class.getSimpleName();
    ...
    public SwipeItemLayoutListview(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeItemLayoutListview(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onFinishInflate() {
        ...
        if (getChildCount() != 2) {
            throw new IllegalStateException(SwipeItemLayoutListview.class.getSimpleName() + "必须有且只有两个子控件");
        }
    ...
    private void performAdapterViewItemClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            int p = view.getPositionForView(SwipeItemLayoutListview.this);
    ...
    private boolean performAdapterViewItemLongClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            try {
                ...
                handled = (boolean) m.invoke(view, SwipeItemLayoutListview.this, p, vId);

            } catch (Exception e) {
                e.printStackTrace();

                if (view.getOnItemLongClickListener() != null) {
                    handled = view.getOnItemLongClickListener().onItemLongClick(view, SwipeItemLayoutListview.this, p, vId);
                }
                if (handled) {
...
//            }
            ...
            ViewCompat.postInvalidateOnAnimation(SwipeItemLayoutListview.this);
        }
    ...
    public interface SwipeItemLayoutDelegate {
         ...
         */
        void onSwipeItemLayoutOpened(SwipeItemLayoutListview swipeItemLayout);
         ...
         * @param swipeItemLayout
         */
        void onSwipeItemLayoutClosed(SwipeItemLayoutListview swipeItemLayout);
         ...
         * @param swipeItemLayout
         */
        void onSwipeItemLayoutStartOpen(SwipeItemLayoutListview swipeItemLayout);
    }
