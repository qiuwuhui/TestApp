...
public class PinnedHeaderListView extends ListView {
	...
	private PinnedHeaderAdapter mAdapter; // PinnedHeaderListView适合配器
	private View mHeaderView; //
	private boolean mHeaderViewVisible;// 是否显示字母
	...
	public void configureHeaderView(int position) {
		...
		position=position-1;
		int state = mAdapter.getPinnedHeaderState(position);// 获取头的状态
		switch (state) {
		...
		case PinnedHeaderAdapter.PINNED_HEADER_PUSHED_UP: { // 弹出
