...
public class ListViewNewsHous extends MyListView implements OnClickListener {
	...
	public ListViewNewsHous(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		initView();
	}

	public ListViewNewsHous(Context context) {
		super(context);
		...
		setOnScrollListener(new OnScrollListener() {
			...
			public void onScroll(AbsListView view, int firstVisibleItem,
				...
				if(firstVisibleItem>=15){
					...
					intent.setAction("HouseholdLifeshow");
