...
public class RoundRecImageView extends ImageView {  
    ...
    private static final int DEFAULT_BORDER_COLOR = 00000000;  
...
//  private float mBorderRadius;  
    ...
    public RoundRecImageView(Context context, AttributeSet attrs, int defStyle) {  
        ...
        mBorderWidth = a.getDimensionPixelSize(  
                R.styleable.CircleImageView_border_width2, DEFAULT_BORDER_WIDTH);  
        mBorderColor = a.getColor(R.styleable.CircleImageView_border_color2,  
    ...
    private void init() {  
         ...
         */  
        roundCornerRadius = (int) TypedValue.applyDimension(  
                TypedValue.COMPLEX_UNIT_DIP, DEF_CORNER_RADIUS, dm);  
    ...
    private RectF imageRect = new RectF(0, 0, getWidth(), getHeight());  
    private RectF boarderRect = new RectF(0, 0, getWidth(), getHeight());  
    private static final float DEF_CORNER_RADIUS = 5F;  
    ...
    protected void onDraw(Canvas canvas) {  
        ...
        imageRect.bottom = getHeight();  
        boarderRect.right = getWidth();  
        boarderRect.bottom = getHeight();  
  
        canvas.drawRoundRect(imageRect, roundCornerRadius, roundCornerRadius,  
                mBitmapPaint);  
  
        if (mBorderWidth != 0) {  
            canvas.drawRoundRect(boarderRect, roundCornerRadius,  
                    roundCornerRadius, mBorderPaint);  
        }  
