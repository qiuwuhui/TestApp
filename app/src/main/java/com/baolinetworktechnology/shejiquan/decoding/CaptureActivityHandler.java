...
package com.baolinetworktechnology.shejiquan.decoding;
...
import com.baolinetworktechnology.shejiquan.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
  ...
  private final CodeActivity mActivity;
  ...
  public CaptureActivityHandler(CodeActivity activity, Vector<BarcodeFormat> decodeFormats,
      String characterSet) {
  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      case MessageIDs.auto_focus:
        ...
        if (mState == State.PREVIEW) {
         // CameraManager.get().requestAutoFocus(this, MessageIDs.auto_focus);
          mActivity.getCameraManager().requestAutoFocus(this, MessageIDs.auto_focus);
        }
        break;
      ...
      case MessageIDs.decode_failed:
        ...
        mActivity.getCameraManager().requestPreviewFrame(mDecodeThread.getHandler(), MessageIDs.decode);
        break;
  ...
  public void quitSynchronously() {
   ...
   //CameraManager.get().stopPreview();
    ...
    Message quit = Message.obtain(mDecodeThread.getHandler(), MessageIDs.quit);
    quit.sendToTarget();
    try {
      mDecodeThread.join();
