...
import com.hyphenate.easeui.ui.EaseBaseFragment1;
import com.hyphenate.easeui.ui.EaseGroupRemoveListener;
import com.hyphenate.easeui.ui.MyRelativeLayout;
...
public class SJQEaseChatFragment extends EaseBaseFragment implements EMMessageListener,OnClickListener{
	  ...
	  protected static final int REQUEST_CODE_LOCAL = 3;
	    ...
	    protected MyRelativeLayout mRoot1;
	    @Override
	    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
	        return inflater.inflate(R.layout.ease_fragment_chat1, container, false);
	    }
	    ...
	    protected void initView() {
			mRoot1 = (MyRelativeLayout) getView().findViewById(R.id.mRoot1);
			mRoot1.setFitsSystemWindows(true);
	        // hold to record voice
	    	ImageView left_image=(ImageView) getView().findViewById(R.id.left_image);
	    	left_image.setOnClickListener(this);
	    	ImageView right_image=(ImageView) getView().findViewById(R.id.right_image);
	    ...
	    protected void selectPicFromCamera() {
	        ...
	        try {
				...
				String path=pickFile.getAbsolutePath();
				...
				Toast.makeText(getActivity(), "当前摄像头无法访问", Toast.LENGTH_SHORT).show();
			}
//	        try {
...
//			}
		...
		private void showCall() {
			new MyAlertDialog(getActivity()).setTitle(SJQApp.kefuCall)
